...
const TOOLS = [
  {
    ...
    desc: 'Convert between MP4, WebM, MOV and AVI containers.',
    color:
  ...
  },
  {
    icon: Scissors,
    title: 'Video Trimmer',
    desc: 'Cut a clip to an exact start and end timestamp.',
    color: 'bg-blue-100 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400',
  },
  {
    icon: Tv,
    title: 'Video Compressor',
    desc: 'Reduce file size to fit email or messaging app limits.',
    color:
  ...
  },
  {
    icon: Zap,
    title: 'Video to GIF',
    desc: 'Export a clip as a looping GIF with custom frame rate.',
    color:
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 sm:p-8 mb-6">
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500">
                Video processing via a high-performance WebAssembly engine
              </p>
            </div>
          </div>
          <p className="mt-5 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
            Video processing is heavier than image work, so we're building these
            tools carefully on a high-performance WebAssembly engine to ensure
            they run smoothly even on lower-powered devices.
          </p>
          <div className="mt-4 flex flex-col gap-2">
            ...
            <div className="flex items-start gap-2 text-[11px] text-amber-600 dark:text-amber-400">
              ...
              <span>
                Large video files may be slower in-browser than desktop software
                - best for clips under a few minutes.
              </span>
            </div>
          </div>
        </div>
