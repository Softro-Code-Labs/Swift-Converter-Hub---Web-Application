...
export const metadata: Metadata = {
  ...
  description:
    'Convert between MP4, WEBM, MOV, AVI and MKV instantly in your browser. Batch convert and download - no uploads, no account, powered by WebAssembly.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Convert between MP4, WEBM, MOV, AVI and MKV - instant, private, no server.',
      ...
      <JsonLd
        data={[
          ...
          softwareApplicationJsonLd({
            ...
            description:
              'Convert between MP4, WEBM, MOV, AVI and MKV entirely in your browser.',
            path: '/video/convert',
